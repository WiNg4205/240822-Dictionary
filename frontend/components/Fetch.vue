  ...
  <ul class="flex flex-col gap-4 py-12 px-20">
    <li v-for="type in types" :key="type.partOfSpeech">
      <ul class="flex flex-col gap-4">
        <li class="border rounded-lg px-4 py-2" :class="{'text-neutral-100 border-neutral-500': darkMode, 'text-black': !darkMode}" v-for="definition in type.definitions" :key="definition.definition">
